...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Lotus versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Lotus keyring")
@click.pass_context
