...
from lotus.daemon.client import acquire_connection_to_daemon
from lotus.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Lotus processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("LOTUS_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
