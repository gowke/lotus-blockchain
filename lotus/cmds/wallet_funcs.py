...
from lotus.cmds.show import print_connections
...
from lotus.cmds.cmds_util import transaction_submitted_msg, transaction_status_msg
...
def print_transaction(tx: TransactionRecord, verbose: bool, name, address_prefix: str, mojo_per_unit: int) -> None:
    if verbose:
        ...
        lotus_amount = Decimal(int(tx.amount)) / mojo_per_unit
        ...
        print(f"Amount {description}: {lotus_amount} {name}")
