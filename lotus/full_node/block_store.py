...
from lotus.util.full_block_utils import block_info_from_block, generator_from_block
from lotus.util.ints import uint32
from lotus.util.lru_cache import LRUCache
from lotus.util.full_block_utils import GeneratorBlockInfo
    ...
    async def create(cls, db_wrapper: DBWrapper2) -> BlockStore:
        ...
        async with self.db_wrapper.writer_maybe_transaction() as conn:
            ...
            if self.db_wrapper.db_version == 2:
                ...
                # in the lotus.cmds/db_upgrade.py file
