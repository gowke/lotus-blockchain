...
class DIDWallet:
    ...
    async def create_update_spend(self, fee: uint64 = uint64(0)):
        ...
        if fee > 0:
            ...
            lotus.tx = await self.create_tandem_xch_tx(fee, Announcement(coin.name(), announcement_to_make))
        else:
        ...
        if lotus.tx is not None and lotus.tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(lotus.tx)
