...
p2_delegated_puzzle_or_hidden_puzzle is essentially the "standard coin" in lotus.
...
from lotus.wallet.util.curry_and_treehash import calculate_hash_of_quoted_mod_hash, curry_and_treehash
